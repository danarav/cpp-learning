...
### Choosing a Language Standard - Configuring your Compiler

In professional environments, it's common to choose a language standard that is one or two version back from the latest finalized standard.
For personal projects and while learning, it is recommended to choose the latest finalized standard.

Each C++ language standard is described by a **standards document**, which is a formal technical document
that is the authoritative source for the rules and requirements of a given language standard.
